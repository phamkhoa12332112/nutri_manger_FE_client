  ...
  import 'package:nutrients_manager/data/repository/statistics_repository.dart';
  ...
  class _ProfileScreenState extends State<ProfileScreen> {
    ...
    Future<void> loadUserData() async {
      ...
      final data = await getCaloriesDataInRange(fetchedUser!.id, endDate!);
    ...
    Future<void> pickDateRange() async {
      ...
      final data = await getCaloriesDataInRange(user!.id, picked!);

      setState(() {
        startDate = picked.subtract(Duration(days: 6));
        endDate = picked;
        caloriesData = data;
      });
    }
